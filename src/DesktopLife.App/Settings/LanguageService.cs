...
public static class LanguageService
{
    ...
    private static readonly Dictionary<string, (string Zh, string En)> Texts = new()
    {
        ...
        ["SaverContentHelp"] = ("设置森林或海洋、明暗背景，以及生物数量和尺寸。", "Set Forest or Ocean, a light or dark background, and creature populations and sizes."),
        ...
        ["PreferencesIntro"] = ("两种场景共享风格、快捷键与录屏选项。", "Both scenes share appearance, shortcuts, and capture preferences."),
        ["Forest"] = ("森林", "Forest"),
        ["Ocean"] = ("海洋", "Ocean"),
        ["HabitatLabel"] = ("桌面场景", "Desktop scene"),
        ["HabitatHelp"] = ("切换场景会保存两组配置，并立即生效。", "Switching scenes saves both populations and applies immediately."),
