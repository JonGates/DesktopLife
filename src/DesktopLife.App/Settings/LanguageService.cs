...
public static class LanguageService
{
    ...
    private static readonly Dictionary<string, (string Zh, string En)> Texts = new()
    {
        ...
        ["AdditionalSpecies"] = ("更多昆虫 · 8 种", "More insects · 8 species"),
        ["AdditionalHelp"] = ("每种 0–100 只，设为 0 时关闭。尺寸为原始体型的 10–300%。这 8 种昆虫在所有风格下均使用写实外观。", "0–100 of each species; 0 disables it. Sizes range from 10–300% of its natural body size. These 8 species keep their realistic appearance in every style."),
