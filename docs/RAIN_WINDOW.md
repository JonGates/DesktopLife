...
主程序「生物」页和屏保内容设置中新增第三个标签「雨窗」。森林／海洋数量保持独立，雨窗中不生成生物。雨量可选毛毛雨、小雨、中雨、大雨、暴雨五档，默认中雨。桌面与屏保分别保存；点击保存应用。雨量随实际显示面积生成，各档总雨滴上限依次为 100、220、600、900、1,200。
...
静止水滴使用四类、共 48 种附着轮廓：小圆珠、偏斜梨形、宽扁形和不规则鼓起。出生时按尺寸选择稳定外形，高光位置、宽度和亮度随个体变化，不逐帧随机变形。开始滑落后恢复原有流动形态；运动和吞并规则不变。
